...
const EmptyIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="10rem" height="1rem" fill="none"
       viewBox="0 0 216 120">
    <g clip-path="url(#EmptyDocuments_svg__a)" opacity="0.84">
      <path fill="#D9D8FF" fill-opacity="0.8" fill-rule="evenodd"
      ...
      <path fill="#fff" fill-rule="evenodd"
            ...
            clip-rule="evenodd"></path>
      <path stroke="#7B79FF" stroke-width="2.5"
            d="m73.162 26.33 4.97-.557m54.429-6.127 10.077 73.496.906 7.374a4.334 4.334 0 0 1-3.773 4.829l-63.44 7.789a4.333 4.333 0 0 1-4.83-3.772l-9.767-79.547a2.166 2.166 0 0 1 1.91-2.417l5.262-.59 63.655-7.162Z"></path>
      <path fill="#F0F0FF" fill-rule="evenodd"
            ...
            clip-rule="evenodd"></path>
      <path fill="#fff" fill-rule="evenodd" stroke="#7B79FF" stroke-width="2.5"
            ...
            clip-rule="evenodd"></path>
      <path stroke="#7B79FF" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
            d="M135.811 7.082v12.564a3.25 3.25 0 0 0 3.25 3.25h8.595M94.644 78.146h28.167m-28.167-55.25h28.167-28.167Zm0 13h46.584-46.584Zm0 14.083h46.584-46.584Zm0 14.084h46.584-46.584Z"></path>
    </g>
    <defs>
