...
export interface ApiPortfolioPortfolio extends Schema.SingleType {
  ...
  attributes: {
    Introduction: Attribute.Component<'about.me'> &
    ...
    Projects: Attribute.Component<'about.projects', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Extras: Attribute.DynamicZone<['about.skills', 'about.certificates']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSubCategorySubCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    new_product: Attribute.Relation<
      ...
      'api::new-product.new-product'
    >;
    super_category: Attribute.Relation<
      'api::sub-category.sub-category',
      'oneToOne',
